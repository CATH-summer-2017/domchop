...
Runing "``main.py``" throws "``ImportError: No module named lib``". Python does not automatically recognise directory as importable. We need to flag a directory by placing "\_\_init\_\_.py" under it. Just do
```
